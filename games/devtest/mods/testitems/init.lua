local S = aperosengine.get_translator("testitems")
...
local overlay_on_use = function(itemstack, user, pointed_thing)
	...
	aperosengine.log("action", "[testitems] Color of "..itemstack:get_name().." changed to "..colorstr)
	return itemstack
end
...
aperosengine.register_craftitem("testitems:overlay_meta", {
...
aperosengine.register_craftitem("testitems:overlay_global", {
...
aperosengine.register_craftitem("testitems:image_meta", {
	...
	on_use = function(itemstack, player)
		...
		aperosengine.chat_send_player(player:get_player_name(), "State " .. state)
...
aperosengine.register_craftitem("testitems:telescope_stick", {
	...
	on_use = function(itemstack, player)
		...
		aperosengine.chat_send_player(player:get_player_name(), "Telescope Stick range set to "..range)
		return itemstack
	end,
})
