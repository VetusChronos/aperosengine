...
aperosengine.register_node("basenodes:stone", {
	description = "Stone",
	tiles = {"default_stone.png"},
	groups = {cracky=3},
})

aperosengine.register_node("basenodes:desert_stone", {
	description = "Desert Stone",
	tiles = {"default_desert_stone.png"},
	groups = {cracky=3},
})

aperosengine.register_node("basenodes:dirt_with_grass", {
...
aperosengine.register_node("basenodes:dirt_with_snow", {
...
aperosengine.register_node("basenodes:dirt", {
	description = "Dirt",
	tiles ={"default_dirt.png"},
	groups = {crumbly=3, soil=1},
})

aperosengine.register_node("basenodes:sand", {
	description = "Sand",
	tiles ={"default_sand.png"},
	groups = {crumbly=3},
})

aperosengine.register_node("basenodes:desert_sand", {
	description = "Desert Sand",
	tiles ={"default_desert_sand.png"},
	groups = {crumbly=3},
})

aperosengine.register_node("basenodes:gravel", {
	description = "Gravel",
	tiles ={"default_gravel.png"},
	groups = {crumbly=2},
})

aperosengine.register_node("basenodes:junglegrass", {
...
aperosengine.register_node("basenodes:tree", {
...
aperosengine.register_node("basenodes:leaves", {
...
aperosengine.register_node("basenodes:jungletree", {
...
aperosengine.register_node("basenodes:jungleleaves", {
...
aperosengine.register_node("basenodes:pine_tree", {
...
aperosengine.register_node("basenodes:pine_needles", {
...
aperosengine.register_node("basenodes:water_source", {
...
aperosengine.register_node("basenodes:water_flowing", {
...
aperosengine.register_node("basenodes:river_water_source", {
...
aperosengine.register_node("basenodes:river_water_flowing", {
...
aperosengine.register_node("basenodes:lava_flowing", {
	...
	paramtype = "light",
	light_source = aperosengine.LIGHT_MAX,
	walkable = false,
	pointable = false,
	diggable = false,
	buildable_to = true,
...
aperosengine.register_node("basenodes:lava_source", {
...
aperosengine.register_node("basenodes:cobble", {
...
aperosengine.register_node("basenodes:mossycobble", {
...
aperosengine.register_node("basenodes:apple", {
	description = "Apple".."\n"..
		"Punch: Eat (+2)",
	drawtype = "plantlike",
	...
	on_use = aperosengine.item_eat(2),
})

aperosengine.register_node("basenodes:ice", {
	description = "Ice",
...
-- distinguishable
aperosengine.register_node("basenodes:snow", {
...
aperosengine.register_node("basenodes:snowblock", {
