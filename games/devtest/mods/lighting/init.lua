...
aperosengine.register_chatcommand("set_lighting", {
	params = "",
	...
	func = function(player_name, param)
		...
		aperosengine.show_formspec(player_name, "lighting", table.concat(form))
	...
	for _,section in ipairs(lighting_sections) do
		...
		for _,v in ipairs(parameters) do
			...
			if fields[section.n.."."..v.n] then
				local event = aperosengine.explode_scrollbar_event(fields[section.n.."."..v.n])
