local function register_entity(name, textures, backface_culling)
	aperosengine.register_entity("gltf:" .. name, {
		initial_properties = {
			visual = "mesh",
...
do
	...
	aperosengine.register_entity("gltf:blender_cube_glb", {
		initial_properties = {
			visual = "mesh",
...
aperosengine.register_entity("gltf:spider_animated", {
	initial_properties = {
		visual = "mesh",
...
aperosengine.register_entity("gltf:simple_skin", {
	initial_properties = {
		visual = "mesh",
...
aperosengine.register_entity("gltf:frog", {
	initial_properties = {
		visual = "mesh",
		mesh = "gltf_frog.gltf",
...
aperosengine.register_node("gltf:frog", {
...
aperosengine.register_chatcommand("show_model", {
	...
	func = function(name, param)
		...
		aperosengine.show_formspec(name, "gltf:model", table.concat{
			"formspec_version[7]",
			"size[10,10]",
