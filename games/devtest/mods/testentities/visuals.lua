...
aperosengine.register_entity("testentities:sprite", {
	initial_properties = {
		visual = "sprite",
...
aperosengine.register_entity("testentities:upright_sprite", {
	initial_properties = {
...
aperosengine.register_entity("testentities:cube", {
	initial_properties = {
		visual = "cube",
		textures = {
...
aperosengine.register_entity("testentities:item", {
	initial_properties = {
		visual = "item",
...
aperosengine.register_entity("testentities:wielditem", {
	initial_properties = {
		visual = "wielditem",
		wield_item = "testnodes:normal",
	},
...
aperosengine.register_entity("testentities:mesh", {
	initial_properties = {
		visual = "mesh",
...
aperosengine.register_entity("testentities:mesh_unshaded", {
	initial_properties = {
		visual = "mesh",
		mesh = "testnodes_pyramid.obj",
		textures = {
...
aperosengine.register_entity("testentities:sam", {
	initial_properties = {
		visual = "mesh",
...
aperosengine.register_entity("testentities:yawsprite", {
	initial_properties = {
...
aperosengine.register_entity("testentities:upright_animated", {
	initial_properties = {
		visual = "upright_sprite",
...
aperosengine.register_entity("testentities:nametag", {
	initial_properties = {
		visual = "sprite",
		textures = { "testentities_sprite.png" },
	},
	...
	on_activate = function(self, staticdata)
		if staticdata ~= "" then
			local data = aperosengine.deserialize(staticdata)
	...
	get_staticdata = function(self)
		return aperosengine.serialize({ color = self.color, bgcolor = self.bgcolor })
	end,
})
