...
for k,v in pairs(simple_nodes) do
	aperosengine.register_node("soundstuff:"..k, {
		description = v[1].."\n"..v[3],
...
aperosengine.register_node("soundstuff:place_failed_attached", {
...
aperosengine.register_node("soundstuff:fall", {
...
aperosengine.register_node("soundstuff:fall_attached", {
...
aperosengine.register_node("soundstuff:footstep_liquid", {
...
aperosengine.register_node("soundstuff:footstep_climbable", {
...
aperosengine.register_tool("soundstuff:punch_use", {
...
aperosengine.register_tool("soundstuff:punch_use_air", {
...
aperosengine.register_node("soundstuff:positional", {
	...
	on_timer = function(pos, elapsed)
		...
		aperosengine.sound_play("soundstuff_mono", { pos = pos, max_hear_distance = dist })
		local timer = aperosengine.get_node_timer(pos)
		timer:start(0.7)
	end,
	on_rightclick = function(pos, node, clicker)
		...
		if clicker and clicker:is_player() then
			...
			aperosengine.chat_send_player(clicker:get_player_name(), "max_hear_distance = " .. diststr)
		end
	end,
