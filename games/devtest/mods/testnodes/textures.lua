...
aperosengine.register_node("testnodes:6sides", {
...
aperosengine.register_node("testnodes:anim", {
...
aperosengine.register_node("testnodes:fill_positioning", {
...
aperosengine.register_node("testnodes:fill_positioning_reference", {
...
for a=1,#alphas do
	...
	aperosengine.register_node("testnodes:alpha_texture_"..alpha, {
	...
	aperosengine.register_node("testnodes:alpha_"..alpha, {
...
aperosengine.register_node("testnodes:alpha_compositing", {
...
aperosengine.register_node("testnodes:generated_png_mb", {
	description = S("Generated Mandelbrot PNG Test Node"),
	tiles = { "testnodes_generated_mb.png" },

	groups = { dig_immediate = 2 },
})
aperosengine.register_node("testnodes:generated_png_ck", {
...
local png_emb = "[png:" .. aperosengine.encode_base64(
	encode_and_check(64, 64, "rgba", data_emb))

aperosengine.register_node("testnodes:generated_png_emb", {
...
aperosengine.register_node("testnodes:generated_png_src_emb", {
...
aperosengine.register_node("testnodes:generated_png_dst_emb", {
...
Note: AperosEngine requires the optional TGA footer for a texture to load.
If a TGA image does not load in AperosEngine, append eight (8) null bytes,
then the string “TRUEVISION-XFILE.”, then another null byte.

]]--

aperosengine.register_node("testnodes:tga_type1_24bpp_bt", {
...
aperosengine.register_node("testnodes:tga_type1_24bpp_tb", {
...
aperosengine.register_node("testnodes:tga_type2_16bpp_bt", {
...
aperosengine.register_node("testnodes:tga_type2_16bpp_tb", {
...
aperosengine.register_node("testnodes:tga_type2_32bpp_bt", {
...
aperosengine.register_node("testnodes:tga_type2_32bpp_tb", {
...
aperosengine.register_node("testnodes:tga_type3_16bpp_bt", {
...
aperosengine.register_node("testnodes:tga_type3_16bpp_tb", {
...
aperosengine.register_node("testnodes:tga_type10_32bpp_bt", {
...
aperosengine.register_node("testnodes:tga_type10_32bpp_tb", {
