...
for d=0, 8 do
	...
	aperosengine.register_node("testnodes:rliquid_"..d, {
	...
	aperosengine.register_node("testnodes:rliquid_flowing_"..d, {
	...
	aperosengine.register_node("testnodes:vliquid_"..d, {
	...
	aperosengine.register_node("testnodes:vliquid_flowing_"..d, {
	...
	local v = 4
	aperosengine.register_node("testnodes:vrliquid_"..d, {
	...
	aperosengine.register_node("testnodes:vrliquid_flowing_"..d, {
