...
for i=1, aperosengine.LIGHT_MAX do
	aperosengine.register_node("testnodes:light"..string.format("%02d", i), {
...
aperosengine.register_node("testnodes:sunlight_filter", {
...
aperosengine.register_node("testnodes:sunlight_propagator", {
