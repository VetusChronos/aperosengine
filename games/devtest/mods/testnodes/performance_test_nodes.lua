...
-- Complex mesh
aperosengine.register_node("testnodes:performance_mesh_clip", {
...
aperosengine.register_node("testnodes:performance_mesh_blend", {
...
-- Overlay
aperosengine.register_node("testnodes:performance_overlay_clip", {
...
-- Overlay
aperosengine.register_node("testnodes:performance_overlay_blend", {
