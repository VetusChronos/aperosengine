...
aperosengine.register_node("testnodes:falling", {
...
aperosengine.register_node("testnodes:falling_facedir", {
...
aperosengine.register_node("testnodes:falling_float", {
...
aperosengine.register_node("testnodes:attached", {
...
aperosengine.register_node("testnodes:attached_wallmounted", {
...
aperosengine.register_node("testnodes:attached_wallmounted_rot", {
...
aperosengine.register_node("testnodes:attached_wallmounted_floor", {
...
aperosengine.register_node("testnodes:attached_wallmounted_floor_rot", {
...
aperosengine.register_node("testnodes:attached_top", {
...
aperosengine.register_node("testnodes:attached_facedir", {
...
aperosengine.register_node("testnodes:attached_4dir", {
...
-- Jump disabled
aperosengine.register_node("testnodes:nojump", {
...
-- Jump disabled plant
aperosengine.register_node("testnodes:nojump_walkable", {
...
aperosengine.register_node("testnodes:climbable", {
...
aperosengine.register_node("testnodes:climbable_nojump", {
...
aperosengine.register_node("testnodes:climbable_nodescend", {
...
aperosengine.register_node("testnodes:climbable_nodescend_nojump", {
...
aperosengine.register_node("testnodes:liquid_nojump", {
...
aperosengine.register_node("testnodes:liquidflowing_nojump", {
...
aperosengine.register_node("testnodes:liquid_noswim", {
...
aperosengine.register_node("testnodes:liquidflowing_noswim", {
...
aperosengine.register_node("testnodes:liquid_nodescend", {
...
aperosengine.register_node("testnodes:liquidflowing_nodescend", {
...
for i=-100, 100, 25 do
	if i ~= 0 then
		...
		aperosengine.register_node("testnodes:damage"..subname, {
			description = desc,
...
for i=-MAX_BOUNCE_NONJUMPY, MAX_BOUNCE_JUMPY, 20 do
	if i ~= 0 then
		...
		aperosengine.register_node("testnodes:bouncy"..num, {
			description = desc,
...
for i=1, 5 do
	aperosengine.register_node("testnodes:slippery"..i, {
...
for r=0, 7 do
	if r > 0 then
		aperosengine.register_node("testnodes:move_resistance"..r, {
	...
	aperosengine.register_node("testnodes:move_resistance_liquidlike"..r, {
		description = mdesc,
		walkable = false,
		move_resistance = r,
...
aperosengine.register_node("testnodes:climbable_move_resistance_4", {
...
aperosengine.register_node("testnodes:buildable_to", {
...
for d=-3,3 do
	if d ~= 0 then
		...
		aperosengine.register_node("testnodes:damage_"..sub, {
			description = desc,
			damage_per_second = d,
...
aperosengine.register_node("testnodes:drowning_1", {
...
aperosengine.register_node("testnodes:post_effect_color_shaded_false", {
...
aperosengine.register_node("testnodes:post_effect_color_shaded_true", {
...
local function register_pointable_test_node(name, description, pointable)
	...
	aperosengine.register_node("testnodes:"..name, {
