...
aperosengine.register_node("testnodes:nodebox_fixed", {
...
aperosengine.register_node("testnodes:nodebox_overhigh", {
...
aperosengine.register_node("testnodes:nodebox_overhigh2", {
...
aperosengine.register_node("testnodes:nodebox_leveled", {
...
aperosengine.register_node("testnodes:nodebox_connected", {
...
aperosengine.register_node("testnodes:nodebox_connected_6side", {
...
-- More walls
aperosengine.register_node("testnodes:nodebox_connected_facedir", {
...
aperosengine.register_node("testnodes:nodebox_connected_4dir", {
...
aperosengine.register_node("testnodes:facedir_to_connect_to", {
...
aperosengine.register_node("testnodes:sign3d", {
...
aperosengine.register_node("testnodes:sign3d_wallmounted", {
...
aperosengine.register_node("testnodes:button", {
