...
-- A regular cube
aperosengine.register_node("testnodes:normal", {
...
aperosengine.register_node("testnodes:glasslike", {
...
aperosengine.register_node("testnodes:glasslike_framed", {
...
-- is missing.
aperosengine.register_node("testnodes:glasslike_framed_no_detail", {
...
aperosengine.register_node("testnodes:glasslike_framed_optional", {
...
aperosengine.register_node("testnodes:allfaces", {
...
aperosengine.register_node("testnodes:allfaces_6", {
...
aperosengine.register_node("testnodes:allfaces_optional", {
...
aperosengine.register_node("testnodes:allfaces_optional_waving", {
...
aperosengine.register_node("testnodes:firelike", {
...
aperosengine.register_node("testnodes:fencelike", {
...
aperosengine.register_node("testnodes:torchlike", {
...
aperosengine.register_node("testnodes:torchlike_wallmounted", {
...
aperosengine.register_node("testnodes:torchlike_wallmounted_rot", {
...
aperosengine.register_node("testnodes:signlike", {
...
aperosengine.register_node("testnodes:signlike_wallmounted", {
...
aperosengine.register_node("testnodes:signlike_rot", {
...
aperosengine.register_node("testnodes:plantlike", {
...
aperosengine.register_node("testnodes:plantlike_waving", {
...
aperosengine.register_node("testnodes:plantlike_wallmounted", {
...
local function rotate_on_rightclick(pos, node, clicker)
	local def = aperosengine.registered_nodes[node.name]
	...
	aperosengine.chat_send_player(clicker:get_player_name(),
		"Rotation is now " .. deg .. " / " .. deg_max)
end

aperosengine.register_node("testnodes:plantlike_degrotate", {
...
aperosengine.register_node("testnodes:mesh_degrotate", {
...
aperosengine.register_node("testnodes:mesh_colordegrotate", {
...
aperosengine.register_node("testnodes:plantlike_leveled", {
...
aperosengine.register_node("testnodes:plantlike_meshoptions", {
...
aperosengine.register_node("testnodes:plantlike_rooted", {
...
aperosengine.register_node("testnodes:plantlike_rooted_wallmounted", {
...
aperosengine.register_node("testnodes:plantlike_rooted_waving", {
...
aperosengine.register_node("testnodes:plantlike_rooted_leveled", {
...
-- param2 changes shape
aperosengine.register_node("testnodes:plantlike_rooted_meshoptions", {
...
aperosengine.register_node("testnodes:plantlike_rooted_degrotate", {
...
for r = 0, 8 do
	aperosengine.register_node("testnodes:liquid_"..r, {
	...
	aperosengine.register_node("testnodes:liquid_flowing_"..r, {
...
aperosengine.register_node("testnodes:liquid_waving", {
...
aperosengine.register_node("testnodes:liquid_flowing_waving", {
...
-- Invisible node
aperosengine.register_node("testnodes:airlike", {
...
aperosengine.register_node("testnodes:glassliquid", {
...
for r=1, #rails do
	...
	if id ~= "groupless" then
		raillike_group = aperosengine.raillike_group(id)
	end
	for c=1, #colors do
		local color
		if colors[c] ~= "" then
		...
		aperosengine.register_node("testnodes:raillike_"..id..c, {
...
local scale = function(subname, append)
	...
	local def = table.copy(aperosengine.registered_items[original])
	local orig_desc
	...
	aperosengine.register_node("testnodes:"..subname.."_double", def)
	def = table.copy(aperosengine.registered_items[original])
	def.visual_scale = 0.5
	def.description = S("Half-sized @1", orig_desc)
	aperosengine.register_node("testnodes:"..subname.."_half", def)
end
