...
aperosengine.register_alias("unittests:steel_ingot_alias", "unittests:steel_ingot")
aperosengine.register_alias("unittests:coal_lump_alias", "unittests:coal_lump")
aperosengine.register_alias("unittests:iron_lump_alias", "unittests:iron_lump")
...
aperosengine.register_tool("unittests:unrepairable_tool", {
...
aperosengine.register_tool("unittests:repairable_tool", {
