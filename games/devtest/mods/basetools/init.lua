...
-- The hand
if aperosengine.settings:get_bool("creative_mode") then
	local digtime = 42
	local caps = {times = {digtime, digtime, digtime}, uses = 0, maxlevel = 256}

	aperosengine.register_item(":", {
		type = "none",
...
aperosengine.register_tool("basetools:pick_mese", {
...
aperosengine.register_tool("basetools:pick_mese_no_delay", {
...
aperosengine.register_tool("basetools:pick_wood", {
...
aperosengine.register_tool("basetools:pick_stone", {
...
aperosengine.register_tool("basetools:pick_steel", {
...
aperosengine.register_tool("basetools:pick_steel_l1", {
...
aperosengine.register_tool("basetools:pick_steel_l2", {
...
aperosengine.register_tool("basetools:shovel_wood", {
...
aperosengine.register_tool("basetools:shovel_stone", {
...
aperosengine.register_tool("basetools:shovel_steel", {
...
aperosengine.register_tool("basetools:axe_wood", {
...
aperosengine.register_tool("basetools:axe_stone", {
...
aperosengine.register_tool("basetools:axe_steel", {
...
aperosengine.register_tool("basetools:shears_wood", {
...
aperosengine.register_tool("basetools:shears_stone", {
...
aperosengine.register_tool("basetools:shears_steel", {
...
aperosengine.register_tool("basetools:sword_wood", {
...
aperosengine.register_tool("basetools:sword_stone", {
...
aperosengine.register_tool("basetools:sword_steel", {
...
aperosengine.register_tool("basetools:sword_titanium", {
...
aperosengine.register_tool("basetools:sword_blood", {
...
-- Max. damage sword
aperosengine.register_tool("basetools:sword_mese", {
...
aperosengine.register_tool("basetools:sword_fire", {
...
aperosengine.register_tool("basetools:sword_ice", {
...
aperosengine.register_tool("basetools:sword_elemental", {
...
aperosengine.register_tool("basetools:dagger_heal", {
...
aperosengine.register_tool("basetools:sword_heal", {
...
aperosengine.register_tool("basetools:sword_heal_super", {
...
--
aperosengine.register_tool("basetools:dagger_wood", {
...
aperosengine.register_tool("basetools:dagger_steel", {
...
for i, params in ipairs(tool_params) do
	...
	aperosengine.register_tool("basetools:pick_uses_"..string.format("%05d", uses), {
	...
	aperosengine.register_tool("basetools:sword_uses_"..string.format("%05d", uses), {
...
aperosengine.register_chatcommand("wear_color", {
	params = "[idx]",
	description = "Set wear bar color override",
	func = function(player_name, param)
		local player = aperosengine.get_player_by_name(player_name)
...
local wear_on_use = function(itemstack, user, pointed_thing)
	...
	aperosengine.log("action", "[basetool] Wear bar color of "..itemstack:get_name().." changed to "..colorstr)
...
aperosengine.register_tool("basetools:random_wear_bar", {
