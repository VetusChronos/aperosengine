...
2. Before you start coding, consider opening an
   [issue at Github](https://github.com/VetusChronos/aperosengine/issues) to discuss the
   ...
   [the roadmap](../docs/en/engine/direction.md) will be closed within a month unless it
   ...
   You may also benefit from discussing on our [Discord](http://discord.gg/CODE/) development channel.

3. Start coding!
    - Refer to the
      [Lua API](https://github.com/VetusChronos/aperosengine/blob/main/docs/en/modding/lua_api.md),
      [Developer Wiki](http://dev.minetest.net/Main_Page) and other
      [documentation](https://github.com/VetusChronos/aperosengine/tree/main/docs/en/).
    ...
    - To avoid conflicting changes between contributions, do not do the following manually. They will be done before each release.
      - Run `updatepo.sh` or update `aperosengine.po{,t}` even if your code adds new translatable strings.
      - Update `aperosengine.conf.example` and `settings_translation_file.cpp` even if your code adds new core settings.

4. Commit & [push](https://help.github.com/articles/pushing-to-a-remote/) your changes to a new branch (not `main`, one change per branch)
...
5. Once you are happy with your changes, submit a pull request.
     - Open the [pull-request form](https://github.com/VetusChronos/aperosengine/pull/new/main).
...
1. It follows [the roadmap](../docs/en/engine/direction.md) in some way and fits the whole
...
2. Is it an issue with the Aperos *engine*? If not, report it
   [elsewhere](http://www.minetest.net/development/#reporting-issues).
3. [Open an issue](https://github.com/VetusChronos/aperosengine/issues/new) and describe
   the issue you are having - you could include:
     - Error logs (check the bottom of the `debug.txt` file).
     - Screenshots.
     - Ways you have tried to solve the issue, and whether they worked or not.
     - Your Aperos Engine version and the content (games, mods or texture packs) you have installed.
...
[the roadmap](../docs/en/engine/direction.md) in some way and fits the whole picture of
...
[here](https://hosted.weblate.org/projects/VetusChronos/aperosengine/).
...
[Translation (Minetest)](https://dev.minetest.net/Translation) for more information.

## Donations

If you'd like to monetarily support Aperos Engine and AperosVoxel game development, you can find donation
methods on [our Itch.io](https://aperosengine.itch.io/).
...
* If it matches a goal in [the roadmap](../docs/en/engine/direction.md), then the PR should
...
- Who intends to merge the pull-request should follow the commit rules:
    ...
    - `curl https://github.com/VetusChronos/aperosengine/pull/1.patch | git am`
...
- Tag issues with the appropriate [labels](https://github.com/VetusChronos/aperosengine/labels) for devices, platforms etc.
