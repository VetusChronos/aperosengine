...
Copyright (C) 2015-2016 kwolekr, Ryan Kwolek <kwolekr@aperosvoxel.domain>
...
int MapgenFlat::getSpawnLevelAtPoint(v2s16 p) {
	...
	float n_terrain =
			((spflags & MGFLAT_LAKES) || (spflags & MGFLAT_HILLS)) ? NoisePerlin2D(&noise_terrain->np, p.X, p.Y, seed) : 0.0f;
