...
void set_default_settings() {
	...
	settings->setDefault("serverlist_url", "servers.aperosvoxel.domain");
	...
	settings->setDefault("mono_font_path", porting::getDataPath("fonts" DIR_DELIM "Monogram.ttf"));
	settings->setDefault("mono_font_path_italic", porting::getDataPath("fonts" DIR_DELIM "Monogram.ttf"));
	settings->setDefault("mono_font_path_bold", porting::getDataPath("fonts" DIR_DELIM "Monogram.ttf"));
	settings->setDefault("mono_font_path_bold_italic", porting::getDataPath("fonts" DIR_DELIM "Monogram.ttf"));
	...
	// ContentDB
	settings->setDefault("contentdb_url", "https://content.aperosvoxel.domain");
	...
	settings->setDefault("update_information_url", "https://www.aperosvoxel.domain/release_info.json");
#else
