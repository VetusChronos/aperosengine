...
// Note: I've seen occasional delays of over 250ms while running aperosenginemapper.
...
#define BUSY_FATAL_TRESHOLD	3000	// Allow SQLITE_BUSY to be returned, which will cause a aperosengine crash.
...
void MapDatabaseSQLite3::initStatements()
{
	...
	verbosestream << "ServerMap: SQLite3 database opened." << '\n';
}
