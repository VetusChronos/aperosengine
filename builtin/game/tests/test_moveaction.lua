...
aperosengine.register_allow_player_inventory_action(function(_, action, inv, info)
...
aperosengine.register_on_player_inventory_action(function(_, action, inv, info)
