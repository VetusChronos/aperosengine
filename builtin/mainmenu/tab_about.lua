...
local core_developers = {
	...
	"sfan5 <sfan5@live.de>",
	"ShadowNinja <shadowninja@aperosvoxel.domain>",
...
local previous_core_developers = {
	...
	"proller",
	"Ilya Zhuravlev (xyz) <xyz@aperosvoxel.domain>",
	"PilzAdam <pilzadam@aperosvoxel.domain>",
	"est31 <MTest31@outlook.com>",
	"kahrl <kahrl@gmx.net>",
	"Ryan Kwolek (kwolekr) <kwolekr@aperosvoxel.domain>",
	"sapier",
	"Zeno",
...
return {
	...
	cbf_formspec = function(tabview, name, tabdata)
		...
		local fs = "image[1.5,0.6;2.5,2.5;" .. core.formspec_escape(logofile) .. "]" ..
			...
			"button_url[1.5,4.1;2.5,0.8;homepage;aperosvoxel.domain;https://www.aperosvoxel.domain/]" ..
