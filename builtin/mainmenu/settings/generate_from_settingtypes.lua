...
local aperosengine_example_header = [[
#    This file contains a list of all available settings and their default value for aperosengine.conf

#    By default, all the settings are commented and not functional.
#    Uncomment settings by removing the preceding #.

#    aperosengine.conf is read by default from:
#    ../aperosengine.conf
#    ../../aperosengine.conf
...
local function create_aperosengine_conf_example(settings)
	local result = { aperosengine_example_header }
...
-- If 'aperosengine.conf.example' appears in the 'bin' folder, the line below may have to be
